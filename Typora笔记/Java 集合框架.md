...
并且，以 `Map` 结尾的类都实现了 `Map` 接口。
 ...
 ![6d15456b972aa27982f3982d242b6257.jpeg](D:\资料\img\6d15456b972aa27982f3982d242b6257.jpeg) 

### 1.1.2. 说说 List,Set,Map 三者的区别？

- `List`(对付顺序的好帮手)： 存储的元素是有序的、可重。
- `Set`(注重独一无二的性质): 存储的元素是无序的、唯一。
...
- `LinkedHashMap`： `LinkedHashMap` 继承自 `HashMap`，所以它的底层仍然是基于拉链式散列结构即由数组和链表或红黑树组成。另外，`LinkedHashMap` 在上面结构的基础上，增加了一条双向链表，使得上面的结构可以保持键值对的插入顺序。同时通过对链表进行相应的操作，实现了访问顺序相关逻辑。详细可以查看：[《LinkedHashMap 源码详细分析（JDK1.8）》](https://link.zhihu.com/?target=https%3A//www.imooc.com/article/22931)
...
5. 内存空间占用： ArrayList 的空 间浪费主要体现在在 list 列表的结尾会预留一定的容量空间，而 LinkedList 的空间花费则体现在它的每一个元素都需要消耗比 ArrayList 更多的空间（因为要存放直接后继和直接前驱以及数据）。
   ...
   > “ 另外推荐一篇把双向链表讲清楚的文章：[https://juejin.im/post/5b5d1a9af265da0f47352f14](https://link.zhihu.com/?target=https%3A//juejin.im/post/5b5d1a9af265da0f47352f14)

   ![f242176a922261a89d952069787631ca.jpeg](D:\资料\img\f242176a922261a89d952069787631ca.jpeg)

   双向循环链表： 最后一个节点的 next 指向 head，而 head 的 prev 指向最后一个节点，构成一个环。

   ![329e1a999674b50b487d3f2c8d8cc2d0.jpg](D:\资料\img\329e1a999674b50b487d3f2c8d8cc2d0.jpg)
...
详见笔主的这篇文章:[通过源码一步一步分析 ArrayList 扩容机制](https://link.zhihu.com/?target=https%3A//github.com/Snailclimb/JavaGuide/blob/master/docs/java/collection/ArrayList-Grow.md)
...
HashMapHashSet实现了 Map 接口实现 Set 接口存储键值对仅存储对象调用 `put()`向 map 中添加元素调用 `add()`方法向 Set 中添加元素HashMap 使用键（Key）计算 HashcodeHashSet 使用成员对象来计算 hashcode 值，对于两个对象来说 hashcode 可能相同，所以 equals()方法用来判断对象的相等性，

### 1.4.3. HashMap 和 TreeMap 区别

`TreeMap` 和`HashMap` 都继承自`AbstractMap` ，但是需要注意的是`TreeMap`它还实现了`NavigableMap`接口和`SortedMap` 接口。

![8ec668cb966a4a682d348af6e8f8a65e.jpeg](D:\资料\img\8ec668cb966a4a682d348af6e8f8a65e.jpeg)
...
![572079542a1393fe122bfb4e347cbd33.jpeg](D:\资料\img\572079542a1393fe122bfb4e347cbd33.jpeg)

### 1.4.5.2. JDK1.8 之后

相比于之前的版本， JDK1.8 之后在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为 8）（将链表转换成红黑树前会判断，如果当前数组的长度小于 64，那么会选择先进行数组扩容，而不是转换为红黑树）时，将链表转化为红黑树，以减少搜索时间。

![524b3247b05e88449f3c061b44b57b67.jpeg](D:\资料\img\524b3247b05e88449f3c061b44b57b67.jpeg)
...
详情请查看：[https://coolshell.cn/articles/9606.html](https://link.zhihu.com/?target=https%3A//coolshell.cn/articles/9606.html)

### 1.4.8. HashMap 有哪几种常见的遍历方式?

[HashMap 的 7 种遍历方式与性能分析！](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/Zz6mofCtmYpABDL1ap04ow)
...
![b6143b821719479bc6e7e261af4c979a.jpeg](D:\资料\img\b6143b821719479bc6e7e261af4c979a.jpeg)

[http://www.cnblogs.com/chengxiao/p/6842045.html](https://link.zhihu.com/?target=http%3A//www.cnblogs.com/chengxiao/p/6842045.html)>

JDK1.7 的 ConcurrentHashMap：

![8612df166d70765549cfc7ffd2401eb9.jpeg](D:\资料\img\8612df166d70765549cfc7ffd2401eb9.jpeg)

[http://www.cnblogs.com/chengxiao/p/6842045.html](https://link.zhihu.com/?target=http%3A//www.cnblogs.com/chengxiao/p/6842045.html)>

JDK1.8 的 ConcurrentHashMap：

![5db9b4eb0b8b0d6293e53c20f9c0b69c.jpeg](D:\资料\img\5db9b4eb0b8b0d6293e53c20f9c0b69c.jpeg)
...
![f80b44fd6de5fa0030163b09732d0f07.jpeg](D:\资料\img\f80b44fd6de5fa0030163b09732d0f07.jpeg)
...
最近使用`Arrays.asList()`遇到了一些坑，然后在网上看到这篇文章：[Java Array to List Examples](https://link.zhihu.com/?target=http%3A//javadevnotes.com/java-array-to-list-examples) 感觉挺不错的，但是还不是特别全面。所以，自己对于这块小知识点进行了简单的总结。
...
![5f83c7746ed62c652935a2f57e3daa5d.jpg](D:\资料\img\5f83c7746ed62c652935a2f57e3daa5d.jpg)
